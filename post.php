...
if($_GET['action'] == "err" && !empty($_GET['id'])){
            ...
            $query = mysqli_query($db,"DELETE FROM forum_replies WHERE id = '{$_GET['id']}'");
...
if ((isset($_POST['create']))) {
    ...
    $date_full = time();
     ...
     $result = mysqli_query($db,"INSERT INTO forum_replies (`post`, `comment`, `date`, `author`) VALUES ('".$h_edit['id']."', '".$content."', '".time()."', '".$myuser->name()."');");
                                        if ($result) {
            ...
            <div class="notification-content">
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Comentaste este tema.</font></font>
            </div>
        </div>
            </div>';
                                        } 
...
<section class="page-container" data-page="foro">
	...
	<div class="page-content">
        <div class="left-side">
        <?php require_once "templates/foro/post_view.php";?>
        <?php require_once "templates/foro/post_comments.php";?>
        </div>
        <div class="right-side">
        <?php require_once "templates/foro/info_author.php";?>
        </div>
	</div>
</section>
