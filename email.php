...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Correo Electronico Ajustes</title>
...
<section class="page-container" data-page="settings_preferences">
	...
	<div class="page-content">
        ...
        <h3 class="aside-title">Correo Electronico</h3>
        <form action="" method="POST">
            <div class="row">
                <input type="email" name="mail" class="rounded-input grey-active" value="<?php echo $myuser->mail;?>">
            </div>
            <div class="form-help">Utilizaremos esta información para restaurar su cuenta en caso de que pierda el acceso.</div>
            <p class="submit-button"><button type="submit" class="rounded-button grey" name="savemail">Guardar</button></p>
        </form>
    </article>
	</div>
</section>
