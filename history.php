...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Mi Historial</title>
...
<!-- Start Content -->
<section class="page-container" data-page="shop_history">
    <header class="page-header flex-container flex-vertical-center">
        <div class="page-header-content"><h1>Mi Historial de Compras</h1> Aqui podras ver tu historial de compras.</div>
    </header>
	<div class="page-content">
	<div class="left-side">
        <?php require_once "templates/store/history.php";?>
    </div>
