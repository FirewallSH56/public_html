...
if ((isset($_POST['create']))) {
    ...
    $date_full = time();
     ...
     $result = mysqli_query($db,"INSERT INTO forum_post (`categorie`, `title`, `content`, `date`, `author`) VALUES ('".$h_edit['id']."', '".$title."', '".$content."', '".time()."', '".$myuser->name()."');");
                                        if ($result) {
                                       header("Location: ".$rise_settings['weblink']."/forum/categorie/".$h_edit['id']."");
                                        } 
                    }
?>
			</div>
...
<section class="page-container" data-page="foro">
	...
	<div class="page-content">
        <?php require_once "templates/foro/new_post.php";?>
	</div>
</section>
