...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Banco</title>
...
<!-- Start Content -->
<section class="page-container" data-page="shop">
    <header class="page-header flex-container flex-vertical-center" style="background-image: url(<?php echo $rise_settings['weblink'];?>/riseweb/images/header-store-currency.png);background-color: #e4c21e;">
        <div class="page-header-content"><h1><?php echo $rise_settings['name'];?> Banco</h1> ¿Te quedaste sin diamantes, creditos? Compra aqui mas..</div>
    </header>
	<div class="page-content">
		<div class="left-side">
        <?php require_once "templates/store/banco.php";?>
    </div>
     <div class="right-side">
        <?php require_once "templates/store/info.php";?>
    </div>
	</div>
</section>
