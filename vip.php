...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Membresias VIP</title>
...
<section class="page-container" data-page="shop">
    <header class="page-header flex-container flex-vertical-center">
        <div class="page-header-content"><h1>Membresia VIP</h1> Actualiza tu cuenta a VIP y obten muchos beneficios y comandos que cualquier otro no tiene.</div>
    </header>
	<div class="page-content">
		<div class="left-side">
        <?php require_once "templates/store/vip.php";?>
    </div>
