...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Precio de Rares</title>
...
<!-- Start Content -->
<section class="page-container" data-page="values">
    <header class="page-header flex-container flex-vertical-center">
        <div class="page-header-content"><h1>Precio de Rares</h1> Aqui encontraras la economia del Hotel!</div>
    </header>
	<div class="page-content">
		<div class="left-side">
        <?php require_once "templates/values/rares.php";?>
    </div>
     <div class="right-side">
        <?php require_once "templates/values/search.php";?>
    </div>
	</div>
</section>
