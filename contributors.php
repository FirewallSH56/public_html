...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Contribuyentes</title>
...
<section class="page-container" data-page="community_contributors">
    <header class="page-header flex-container flex-vertical-center">
        <div class="page-header-content"><h1>Contribuyentes</h1> Usuarios voluntarios encargos del entretenimiento del hotel y publicidad del mismo.</div>
    </header>

	<div class="page-content">
    <div class="left-side">
<?php
  $ranks = mysqli_query($db, "SELECT * FROM ranks WHERE id IN (3, 4, 5) ORDER BY id DESC");
...
<?php } if(mysqli_num_rows($users) == 0) { echo 'No hay nadie con este cargo por ahora...';}?>
	...
	<div class="right-side">
        <aside class="default-section">
            ...
            <p><center>¿Quieres formar parte del equipo de <?php echo $rise_settings['name'];?>?</center>
            	</p>
        </aside>
</section>
</div>
