...
<head>
    ...
    <title><?php echo $rise_settings['name'];?> - Fotos</title>
...
<section class="page-container" data-page="community_photos">
	<header class="page-header flex-container flex-vertical-center">
		<div class="page-header-content"><h1>Los mejores momentos del Hotel</h1> Todos los mejores momentos capturados en fotos.</div>
	</header>
		...
		<div class="photos-container">
			...
			<div class="photo-container">
				<div class="photo-content">
					<a href="#" class="photo-picture" target="_blank" style="background-image: url(https://i.imgur.com/sVbDiIM.png);" data-title="Taken by Pro"></a>
					<a href="#" class="photo-meta flex-container flex-vertical-center">
						<div class="photo-meta-left-side"><img src="https://habbo.es/habbo-imaging/avatarimage?figure=lg-3116-82-92.cp-3128-92.ea-3398-82-92.ch-3109-92-82.hr-8407-34.hd-209-1014.sh-305-92.ha-7684-92-92&action=std&gesture=std&direction=2&head_direction=2&size=n&img_format=png&headonly=1" alt="Pro" class="pixelated"></div>
						<div class="photo-meta-right-side">
							<div class="creator-name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Pro</font></font></div>
							<div class="published-date"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Today at 16:53</font></font></div>
						</div>
					</a>
				</div>
			</div>
